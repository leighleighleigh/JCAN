...
extern "C" {
::std::size_t org$jorzacan$cxxbridge1$Bus$operator$sizeof() noexcept;
::std::size_t org$jorzacan$cxxbridge1$Bus$operator$alignof() noexcept;
...
::std::size_t Bus::layout::size() noexcept {
  return org$jorzacan$cxxbridge1$Bus$operator$sizeof();
}

::std::size_t Bus::layout::align() noexcept {
  return org$jorzacan$cxxbridge1$Bus$operator$alignof();
}
...
extern "C" {
::org::jorzacan::Bus *cxxbridge1$box$org$jorzacan$Bus$alloc() noexcept;
void cxxbridge1$box$org$jorzacan$Bus$dealloc(::org::jorzacan::Bus *) noexcept;
void cxxbridge1$box$org$jorzacan$Bus$drop(::rust::Box<::org::jorzacan::Bus> *ptr) noexcept;
} // extern "C"

namespace rust {
inline namespace cxxbridge1 {
template <>
::org::jorzacan::Bus *Box<::org::jorzacan::Bus>::allocation::alloc() noexcept {
  return cxxbridge1$box$org$jorzacan$Bus$alloc();
}
template <>
void Box<::org::jorzacan::Bus>::allocation::dealloc(::org::jorzacan::Bus *ptr) noexcept {
  cxxbridge1$box$org$jorzacan$Bus$dealloc(ptr);
}
template <>
void Box<::org::jorzacan::Bus>::drop() noexcept {
  cxxbridge1$box$org$jorzacan$Bus$drop(this);
}
} // namespace cxxbridge1
} // namespace rust
