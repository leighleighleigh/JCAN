...
namespace org {
namespace jcan {
#ifndef CXXBRIDGE1_STRUCT_org$jcan$Frame
#define CXXBRIDGE1_STRUCT_org$jcan$Frame
struct Frame final {
  ::std::uint32_t id;
...
::std::size_t cxxbridge1$rust_vec$org$jcan$Frame$len(::rust::Vec<::org::jcan::Frame> const *ptr) noexcept;
::std::size_t cxxbridge1$rust_vec$org$jcan$Frame$capacity(::rust::Vec<::org::jcan::Frame> const *ptr) noexcept;
::org::jcan::Frame const *cxxbridge1$rust_vec$org$jcan$Frame$data(::rust::Vec<::org::jcan::Frame> const *ptr) noexcept;
void cxxbridge1$rust_vec$org$jcan$Frame$reserve_total(::rust::Vec<::org::jcan::Frame> *ptr, ::std::size_t new_cap) noexcept;
void cxxbridge1$rust_vec$org$jcan$Frame$set_len(::rust::Vec<::org::jcan::Frame> *ptr, ::std::size_t len) noexcept;
void cxxbridge1$rust_vec$org$jcan$Frame$truncate(::rust::Vec<::org::jcan::Frame> *ptr, ::std::size_t len) noexcept;
} // extern "C"
...
Vec<::org::jcan::Frame>::Vec() noexcept {
  cxxbridge1$rust_vec$org$jcan$Frame$new(this);
}
template <>
void Vec<::org::jcan::Frame>::drop() noexcept {
  return cxxbridge1$rust_vec$org$jcan$Frame$drop(this);
}
template <>
::std::size_t Vec<::org::jcan::Frame>::size() const noexcept {
  return cxxbridge1$rust_vec$org$jcan$Frame$len(this);
}
template <>
::std::size_t Vec<::org::jcan::Frame>::capacity() const noexcept {
  return cxxbridge1$rust_vec$org$jcan$Frame$capacity(this);
}
template <>
::org::jcan::Frame const *Vec<::org::jcan::Frame>::data() const noexcept {
  return cxxbridge1$rust_vec$org$jcan$Frame$data(this);
}
template <>
void Vec<::org::jcan::Frame>::reserve_total(::std::size_t new_cap) noexcept {
  return cxxbridge1$rust_vec$org$jcan$Frame$reserve_total(this, new_cap);
}
template <>
void Vec<::org::jcan::Frame>::set_len(::std::size_t len) noexcept {
  return cxxbridge1$rust_vec$org$jcan$Frame$set_len(this, len);
}
template <>
void Vec<::org::jcan::Frame>::truncate(::std::size_t len) {
  return cxxbridge1$rust_vec$org$jcan$Frame$truncate(this, len);
}
} // namespace cxxbridge1
} // namespace rust
