...
fn main() {
    ...
    println!("cargo:info=project_dir: {}", project_dir.display());
    ...
    println!("cargo:info=project_out_dir: {}", out_dir.display());
    ...
    if !lib_build_path.exists() {
        println!("Library not found at {}", lib_build_path.display());
        println!("Quitting");
        // Quit
        return;
    }
